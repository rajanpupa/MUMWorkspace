...
public final class AFieldaccessThirdFieldAccess extends PFieldAccess
{
    private PArrayRef _arrayRef_;

    public AFieldaccessThirdFieldAccess()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new AFieldaccessThirdFieldAccess(
    ...
    {
        ((Analysis) sw).caseAFieldaccessThirdFieldAccess(this);
    }
