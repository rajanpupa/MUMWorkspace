...
public final class APrimaryEightPrimary extends PPrimary
{
    private TFalse _false_;

    public APrimaryEightPrimary()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new APrimaryEightPrimary(
    ...
    {
        ((Analysis) sw).caseAPrimaryEightPrimary(this);
    }
