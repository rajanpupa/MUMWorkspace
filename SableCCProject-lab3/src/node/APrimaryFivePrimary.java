...
public final class APrimaryFivePrimary extends PPrimary
{
    private TStringLiteral _stringLiteral_;

    public APrimaryFivePrimary()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new APrimaryFivePrimary(
    ...
    {
        ((Analysis) sw).caseAPrimaryFivePrimary(this);
    }
