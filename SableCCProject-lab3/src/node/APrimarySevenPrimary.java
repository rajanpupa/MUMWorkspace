...
public final class APrimarySevenPrimary extends PPrimary
{
    private TTrue _true_;

    public APrimarySevenPrimary()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new APrimarySevenPrimary(
    ...
    {
        ((Analysis) sw).caseAPrimarySevenPrimary(this);
    }
